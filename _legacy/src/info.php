...
<body>
  <div data-role="page" id="info" class="ui-page-theme-b">
    ...
    <div role="main" class="ui-content" aria-label="Info page">
      <p>
        Vitajte na stránke <b>Jednotný Katolícky Spevník</b> (JKS) určenej pre mobilné zariadenia. Vznikla ako moja osobná iniciatíva katolíka zvyknutého na istý komfort, ktorý mi návštevou svätej omše v inej farnosti ako mojej domácej chýbal.
      </p>
      <p>
      ...
      <p>
        Stránku som vytvoril vo svojom voľnom čase a prevádzkujem ju z vlastných úspor. Verím, že cena webhostingu a domény nenarastie natoľko, aby som si jej prevádzku nevedel dovoliť. Dúfam, že pomôže aj ostatným častejšie sa zapájať do spevu počas svätej omše, zvlášť mladým ľuďom, ktorí knižku JKS možno v ruke nikdy nedržali, avšak ani svoj mobil nikdy z ruky nepustili :-).
      </p>
      <p>
        Ak by ste stránku vedeli vylepšiť, prípadne chcete len opraviť chybu, jej zdrojový kód je voľne dostupný na <a href="https://github.com/stanislavbebej/ejks" target="_blank" rel="noopener noreferrer">GitHub</a>.
      </p>
    </div>
